...
public class SWTGraphics2D extends Graphics2D {
	...
	public void setFont(Font font) {
		...
		/**Outcommented by Pontus untill I've found a good way to dispose old fonts**/
...
//		gc.setFont( swtFont );
	...
	public boolean drawImage(Image image, int x, int y, int width, int height,
		...
		ImageData swtImage =  convertToSWT(bi);
		if(swtImage == null)
			return false;
		
		org.eclipse.swt.graphics.Image im = new org.eclipse.swt.graphics.Image(gc.getDevice(), swtImage);
		gc.drawImage(im, x, y);
		im.dispose();
		return true;
	}
...
//		TODO
//		Add support for component colormodel to handle jpg and png files
		return null;
	}
}
